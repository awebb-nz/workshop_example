...
## Warning: this code is now out of date ##
...
#g = sns.factorplot(
#    y="brand", data=df, kind="count", palette="Reds_r", size=7, aspect=1.5
#)
...
#
## saving the plot
#g.savefig((abs_path + "/brand-vehicleCount.png"))
#
#
...
#
## saving the plot
#fig.savefig((abs_path + "/vehicletype-gearbox-price.png"))
#
